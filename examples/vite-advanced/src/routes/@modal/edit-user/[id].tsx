...
export default function EditUserModal({ params }: { params: { id: string } }) {
	...
	return (
		<div role="dialog" aria-modal="true" style={overlay} onClick={close}>
			...
			>
				...
				<p>
					This modal lives at <code>/edit-thing/{params.id}</code> and
					is defined in <code>routes/@modal/edit-thing/[id].tsx</code>
					.
				</p>
				<p style={{ color: '#666' }}>
