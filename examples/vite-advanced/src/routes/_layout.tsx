		...
		<div style={{ fontFamily: 'sans-serif', padding: '1rem' }}>
			<header style={{ borderBottom: '1px solid #ddd', paddingBottom: '0.5rem', marginBottom: '1rem' }}>
				...
				<nav style={{ display: 'flex', gap: '0.75rem', marginTop: '0.5rem' }}>
					<NavLink href="/" exact activeClass="active">Home</NavLink>
					<NavLink href="/about" activeClass="active">About</NavLink>
					<NavLink href="/pricing" activeClass="active">Pricing</NavLink>
					<NavLink href="/users" activeClass="active">Users</NavLink>
					<NavLink href="/docs/getting-started/install" activeClass="active">Docs</NavLink>
				</nav>
			</header>
			<main>{children}</main>
		</div>
